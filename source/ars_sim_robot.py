...
class ArsSimRobot:
  ...
  #
  flag_robot_vel_lin_cmd = [True, True, False]
  ...
  def simRobot(self, time_stamp_ros):
  	...
  	if(self.flag_disp_pitch_roll):
  		...
  		new_robot_atti_ang_roll  = math.atan2( robot_accel_lin_robot[1]+self.aerodynamics_coef['y']*self.robot_velo_lin_robot[1]*self.robot_velo_lin_robot[1], robot_accel_lin_robot[2]+self.aerodynamics_coef['z']*self.robot_velo_lin_robot[2]*self.robot_velo_lin_robot[2]+self.gravity )
